...
private slots:
    ...
    void onSalaSelected(); void onDataSelected(); void onOraSelected();
    ...
    void onAdminAddOra(); void onAdminDeleteOra(); void onAdminDeleteUser();
    // misc
...
private:
    ...
    QLabel      *miniSala,*miniData,*miniOra,*miniLoc,*miniFood,*miniConf;
